...
COPY index.html styles.css script.js config.js notas.js notify.js theme.js mobilenav.js assistant.js manifest.webmanifest sw.js pwa.js /usr/share/nginx/html/
